...
Tasks
1. Create a new StorageClass named local-storage with the provisioner rancher.io/local-path. Set the VolumeBindingMode to WaitForFirstConsumer. Do not make the SC default
